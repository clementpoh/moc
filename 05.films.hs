module Films      -- Borrows film list from Doets and Van Eijk
where
...
isCharacter = (`elem` characters)
isActor     = (`elem` actors)
isMovie     = (`elem` movies)
isDirector  = (`elem` directors)
isDate      = (`elem` dates)
...
db 
  = [ ["character", "Romeo"]
    ...
    , ["release", "The Bourne Identity", "2002"]
    ...
    , ["direct", "Doug Liman", "The Bourne Identity"]
    ...
    , ["play", "Matt Damon", "The Bourne Identity", "Jason Bourne"] 
    , ["play", "Franka Potente", "The Bourne Identity", "Marie Kreutz"] 
    ]
